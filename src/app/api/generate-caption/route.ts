...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  const CNB_CONTEXT = 'CNB CUT Barbershop, Sterling VA. Website: www.cnbcut.com. Phone: 703-665-2675. Luxury barbershop, black and gold theme. Services: haircuts, skin fades, beard grooming, straight razor shaves, hot towel services, kids cuts, head shaves, camouflage color for gray hair, facial waxing. Amenities: complimentary beverage bar (soda, water, coffee, tea), luxury black and gold waiting area. When referencing a booking link or website, use www.cnbcut.com instead of "link in bio".';
